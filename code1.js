...
gdjs.MenuCode.userFunc0xa1b070 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.MenuCode.userFunc0xa1b070(runtimeScene, objects);
...
gdjs.MenuCode.userFunc0xa1b170 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10970076);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10972084);
}
}
}
if (isConditionTrue_0) {
...
gdjs.MenuCode.userFunc0xa1b170(runtimeScene, objects);
