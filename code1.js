...
gdjs.MenuCode.userFunc0xac36a0 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.MenuCode.userFunc0xac36a0(runtimeScene, objects);
...
gdjs.MenuCode.userFunc0x9ef2d0 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11167828);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11169836);
}
}
}
if (isConditionTrue_0) {
...
gdjs.MenuCode.userFunc0x9ef2d0(runtimeScene, objects);
